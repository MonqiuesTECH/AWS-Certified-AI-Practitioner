...
# No more importing files! Just add new questions to this list.
quiz_data = [
    {
        ...
        "explanations": {
            "Amazon Textract": "✅ **Correct! The answer is Amazon Textract.**\n\n🤖 **System AI Analysis:**\nImagine you have a stack of paper tax forms and you need to type all that data into a spreadsheet. Amazon Textract is that highly trained clerk, but digitized. It actually understands the structure, keeping table rows and columns intact.",
            ...
            "Amazon Kendra": "❌ **Incorrect. The answer is not Amazon Kendra.**\n\n🤖 **System AI Analysis:**\nAmazon Kendra is an enterprise search engine, like a private Google for your company's internal files. It searches for answers, but does not extract raw text from images."
        }
    },
    {
